...
const clearPayloadByToolType = {
  baggage: { filterType: 'baggage', Values: [] },
  stops: { filterType: 'stop', Values: ['all'] },
  departureTime: { filterType: 'departtimeslotfilter', Values: [] },
  arrivalTime: { filterType: 'departlandtimeslotfilter', Values: [] },
  airline: { filterType: 'airline', Values: ['all'] },
  layoverAirport: { filterType: 'outboundlayover', Values: ['all'] },
  departureAirport: { filterType: 'outbounddepart', Values: ['all'] },
  arrivalAirport: { filterType: 'outboundarrival', Values: ['all'] },
};
    ...
    .array(
      z.object({
        filterType: z
          ...
          .describe(
            'Filter category: baggage, departureTime, arrivalTime, stops, totalDuration, layoverDuration, price, airline, layoverAirport, departureAirport, arrivalAirport, or reset.',
          ),
        filterCode: z
          .string()
          .nullable()
...
function normalizeAirlineAliasValue(value) {
...
function resolveAirlineSourceOptionMatches(requestedName, airlineOptions) {
...
function rawTextMatchesAirlineCandidate(rawText, candidate) {
...
function normalizeAirportAliasValue(value) {
  return normalizeComparableSourceValue(value)
    .split(' ')
...
function optionMatchesAirportAlias(option, requestedAirport) {
...
function isGenericAirportSelectionRequest(value) {
...
function isClearWholeFilterIntent(filter) {
...
function buildClearPayload(filterType) {
...
function buildRemovalFilterPayloads(existingFilters, incomingFilters, updatedFilters) {
  if (hasClearAllIntent(incomingFilters)) {
...
function mergeFinalAndRemovalPayloads(finalFilterPayload, removalPayloads) {
